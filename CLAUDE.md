...
Services declare Kafka event pipelines and CQRS write endpoints, with most boilerplate auto-generated by `tools/specgen` into `deploy/<svc>/values-generated.yaml`:
...
- `events.kafka.broker` — cluster bootstrap URL (also injected as `KAFKA_BROKERS` env var into the ConfigMap).
